        ...
        <div className="bg-green-900 bg-opacity-55 pt-6 pb-12 sm:pb-16 md:pb-20 lg:pb-28 xl:pb-32">
          <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
            <nav className="relative justify-center gap-2 place-items-center sm:h-64 grid grid-cols-8">
              <Link href="/about">
                <a className="text-lg font-semibold text-gray-100 hover:text-gray-400 transition duration-150 ease-in-out">About</a>
              </Link>
              <Link href="/trees">
                <a className="text-lg font-semibold text-gray-100 hover:text-gray-400 transition duration-150 ease-in-out">Christmas Trees</a>
              </Link>
              <Link href="/rancho-cucamonga"><a className="text-lg font-semibold text-gray-100 hover:text-gray-400 transition duration-150 ease-in-out">Find Us</a>
              </Link>
              ...
              <Link href="/delivery">
                <a className="text-lg font-semibold text-gray-100 hover:text-gray-400 transition duration-150 ease-in-out">Tree Delivery</a>
              </Link>
              <Link href="/contact">
                <a className="text-lg font-semibold text-gray-100 hover:text-gray-400 transition duration-150 ease-in-out">Contact</a>
              </Link>
              <Link href="/coupon">
                <a className="text-lg font-semibold text-gray-100 hover:text-gray-400 transition duration-150 ease-in-out">Get $10 Off</a>
              </Link>
            ...
            <div className="rounded-lg shadow-md">
              <div className="rounded-lg bg-white shadow-xs overflow-hidden" role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
                ...
                <div className="px-2 pt-2 pb-3">
                  <Link href="#"><a className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out" role="menuitem">Product</a>
                  </Link> 
                  <Link href="#"><a className="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out" role="menuitem">Features</a>
                  </Link>
                  <Link href="#"><a className="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out" role="menuitem">Marketplace</a>
                  </Link>
                  <Link href="#"><a className="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out" role="menuitem">Company</a>
                  </Link>
                </div>
                <div>
